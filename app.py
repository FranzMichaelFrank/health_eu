            ...
            [
                html.Div(
                    [
                        ...
                        html.P(),
                        html.P("Select nutrition category", className="control_label",style={"text-align": "center","font-weight":"bold"}),
...
def display_choropleth(candi):
    fig = px.choropleth_mapbox(
        ...
        locations="iso_a3", featureidkey="properties.gu_a3",hover_name = "Country" , #hover_data = [],
