            ...
            [
                html.Div(
                    [
                        ...
                        html.P(
                            "The cultures and customs of the 27 EU countries differ widely. The same applies to their eating habits." 
                            " On the map on the right, the respective food supply can be explored in kilograms per capita per year.",
                            className="control_label",style={"text-align": "justify"}
                        ),
                        html.P(),
                        html.P("Select a nutrition category", className="control_label",style={"text-align": "center","font-weight":"bold"}),
            ...
            [   
                ...
                html.Div(
                    [   html.H6("Analysing the correlations between food consumption and health", style={"margin-top": "0","font-weight": "bold","text-align": "center"}),
                        ...
                        html.Div([
                        html.P("Select nutrition category", className="control_label", style={"font-weight": "bold", "text-align": "center"}),
                        dcc.Dropdown(
                            id='xaxis-column',
                        ...
                        html.Div([
                        html.P("Select health variable", className="control_label", style={"font-weight": "bold", "text-align": "center"}),
                        dcc.Dropdown(
                            id='yaxis-column',
